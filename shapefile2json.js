...
// console.log(
//   parseCSV(fs.readFileSync(path.join(__dirname, "shapes-sample.txt"), "utf8"))
// );
...
const shapefile = fs.readFileSync(
  path.join(__dirname, "data/shapes-sample.txt"),
  "utf8"
);
var shapes = gtfs2geojson.lines(shapefile);

console.log(shapes);

fs.writeFileSync("geojson/temp_route_sydney.json", JSON.stringify(shapes));
